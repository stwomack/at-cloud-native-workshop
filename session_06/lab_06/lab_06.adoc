...
+
. Later you will set up your own configuration repository in Github.  For now, enter "https://github.com/stwomack/womack-configrepo". Click Submit when ready.
+
...
+
----
$ cd $COURSE_HOME/session_06/lab_06/hello-world
----
...
+
----
$cf push hello-world-{{your-initials}} --no-start
...
----
$cf api
API endpoint: https://api.sys.cloud-01.pcf.ascension.org (API version: 2.43.0)
----
...
+
----
$cf set-env hello-server CF_TARGET https://api.sys.cloud-01.pcf.ascension.org
Setting env variable 'CF_TARGET' to 'https://api.sys.cloud-01.pcf.ascension.org' for app hello-server in org instructor-org / space development as instructor...
OK
...
+
----
$cf set-env hello-ui CF_TARGET https://api.sys.cloud-01.pcf.ascension.org
Setting env variable 'CF_TARGET' to 'https://api.sys.cloud-01.pcf.ascension.org' for app hello-ui in org instructor-org / space development as instructor...
OK
TIP: Use 'cf restage' to ensure your env variable changes take effect
----
