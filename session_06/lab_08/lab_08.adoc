...
+
----
$ cd $COURSE_HOME/session_06/lab_08/
----
...
link:/README.md#course-materials[Course Materials home] | link:/session_06/lab_09/lab_09.adoc[Lab 9 - Circuit Breaker Dashboard]
